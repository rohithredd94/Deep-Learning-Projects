...
def get_class_name_from_filename(file_name):
    ...
    #match = re.match(r'(_[0-9]+\.jpg)', file_name, re.I)
    classname = "phone"
...
def main(_):
    ...
    train_output_path = os.path.join(FLAGS.output_dir, 'phone_train.record')
    val_output_path = os.path.join(FLAGS.output_dir, 'phone_val.record')
