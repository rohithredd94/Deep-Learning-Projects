...
flags.DEFINE_string('input_type', 'image_tensor', 'Type of input node. Can be '
                    ...
                    '`tf_example`]')
flags.DEFINE_string('pipeline_config_path', './data/faster_rcnn_resnet152_coco.config',
                    'Path to a pipeline_pb2.TrainEvalPipelineConfig config '
                    'file.')
flags.DEFINE_string('trained_checkpoint_prefix', './data/model.ckpt-100',
                    'Path to trained checkpoint, typically of the form '
                    'path/to/model.ckpt')
flags.DEFINE_string('output_directory', './output', 'Path to write outputs.')
